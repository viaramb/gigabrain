...
- If MCP is unavailable, use the generated \`.claude/actions/\` helper scripts or \`npx --yes --package @legendaryvibecoder/gigabrain@<version> ...\`, not raw \`node ~/.npm/_npx/.../scripts/gigabrainctl.js\` cache paths.
